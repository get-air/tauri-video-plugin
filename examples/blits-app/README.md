# Air / Blits native-video example
...
The canvas integration comes from `@get-air/video/canvas`; this example injects a
...
same authored rectangle passed to `attachCanvasVideo`. Text, badges, and the
